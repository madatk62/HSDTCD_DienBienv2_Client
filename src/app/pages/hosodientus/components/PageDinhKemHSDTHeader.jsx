          ...
          <div className='card card-body'>
            <Form form={form} hideRequiredMark autoComplete='off'>
              <div className='row'>
                ...
                <div className='col-xl-6 col-lg-6'>
                  <FormItem label='Thời gian tạo' name='thoiGianTao'>
                    <RangePicker
                      placeholder={['Từ ngày', 'Đến ngày']}
                      onChange={(value) => {
                        var formatedTuNgay = value[0].format('YYYY-MM-DDT00:00')
                        var formatedDenNgay = value[1].format('YYYY-MM-DDT23:59:59')
                        setTuNgay(formatedTuNgay)
                        setDenNgay(formatedDenNgay)
                      }}
                    />
                  </FormItem>
                </div>
